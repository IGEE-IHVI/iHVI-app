...
3. Prepare seperate .csv files for each indicators/parameters for input. You can also find the datasets for whole Australia SA1s (year 2021) [here](https://github.com/IGEE-IHVI/iHVI-app/tree/main/sample%20data).
